...
<style type="text/css">
  ...
  <body>
    ...
    <form action="${pageContext.request.contextPath }/book_bookUpload.do" method="post" enctype="multipart/form-data">
    	图书名称：<input style="width: 150px; height: 20px;" type="text" name="name"/><br/>
